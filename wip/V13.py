...
class RevueProjet:
    ...
    def afficher(self):
        ...
        Grid.columnconfigure(self.frame, 2, weight=20)
        Grid.columnconfigure(self.frame, 3, weight=20) 
        ...
        self.loglabel.grid(row=2,column=0,sticky='nsew')
